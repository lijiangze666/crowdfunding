...
const Hero = ({titleData, createCampaign}) => {
    ...
    return (
        <div className="relative">
            ...
            <img
                src="https://images.pexels.com/photos/3228766/pexels-photo-3228766.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
                className="absolute inset-0 w-full h-full object-cover"/>
            <div className="relative backgroundMain bg-opacity-75">
                <svg className="absolute inset-x-0 bottom-0 text-white" viewBox="0 0 1160 163">
                    <path fill="currentColor"
                          d="M-164 13L-104 39.7C-44 66 76 120 196 141C316 162 436 152 556 119.7C676 88 796 34 916
                          13C1036 -8 1156 2 1216 7.7L1276 13V162.5H1216C1156 162.5 1036 162.5 916 162.5C796
                          162.5 676 162.5 556 162.5C436 162.5 316 162.5 196 162.5C76 162.5 -44 162.5 -104 162.5H-164V13Z"/>
                </svg>
                <div
                        ...
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <a
                                ...
                                <svg
                                    ...
                                    fill="currentColor"
                                    viewBox="0 0 12 12">
                                    <path d="M9.707 5.293l-5-5A1 1 0 0 0 3.293 1.707L7.586 6,3.293,10.293a1 1 0 1 0
                                1.414,1.414l5-5A1 1 0 0 0 9.707,5.293Z"/>
                                </svg>
                            </a>
                        </div>
                                ...
                                <from>
                                    ...
                                    <div className="mt-4 mb-2 sm:mb-4">
                                        <button
                                            ...
                                            shadow-md bg-teal-accent-400 hover:bg-teal-accent-700 focus:shadow-outline focus:outline-none background">
                                            Create Campaign
                                        </button>
                                    </div>
